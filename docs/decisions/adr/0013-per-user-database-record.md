...
problem; that lives in docs/guidance/P-CUS-customization.md.

## Decision

In the context of TODO, facing TODO, we decided for **Per-user database record** and neglected **localStorage in user browser** and **Importable/Exportable JSON file**,
