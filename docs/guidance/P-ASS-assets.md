# Package: Entity Catalogue (P-ASS)
 
**Scope:** Creating, reading, updating, deleting and listing a catalogue of
domain entities that users maintain by hand.
...
- **Refs:** https://martinfowler.com/eaaCatalog/
