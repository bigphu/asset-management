...
problem; that lives in docs/guidance/P-ASS-assets.md.

## Decision

In the context of TODO, facing TODO, we decided for **Offset/limit** and neglected **Cursor-based** and **No pagination**,
