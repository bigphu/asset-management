...
problem; that lives in docs/guidance/P-EXP-export.md.

## Decision

In the context of TODO, facing TODO, we decided for **All filtered rows** and neglected **The page currently displayed**, **Entire table** and **Checkbox for user choice**,
