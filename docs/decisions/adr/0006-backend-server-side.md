...
In the context of TODO, facing TODO, we decided for **Backend (server-side)** and neglected **In browser (client-side)** and **Dedicated report generation service**,
